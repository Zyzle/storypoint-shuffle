...
function Dialog({ children, ...options }: { children: ReactNode } & DialogOptions) {
...
const DialogTrigger = forwardRef<HTMLElement, HTMLProps<HTMLElement> & DialogTriggerProps>(
...
export { Dialog, DialogTrigger, DialogContent, DialogHeading, DialogDescription, DialogClose };
